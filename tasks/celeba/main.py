...
if __name__ == "__main__":
    ...
    encoder = nn.Sequential(
        nn.Conv2d(3, encoder_hid * 2 ** 0, filter_size, padding=pad), nn.ELU(),  # (bs, 32, h, w)
    ...
    vnca = VNCA(h, w, 3, z_size, encoder, update_net, train_data, val_data, test_data, state_to_dist)
    vnca.eval_batch()
