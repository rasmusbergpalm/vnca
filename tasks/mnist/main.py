...
if __name__ == "__main__":
    ...
    encoder = nn.Sequential(
        nn.Conv2d(1, encoder_hid * 2 ** 0, filter_size, padding=pad + 2), nn.ELU(),  # (bs, 32, h, w)
    ...
    vnca = VNCA(h, w, 1, z_size, encoder, update_net, train_data, test_data, test_data, state_to_dist)
    vnca.eval_batch()
